...
// Popup
const contactBuilderBtn = document.querySelectorAll(".contact-builder");
contactBuilderBtn.forEach((element) => {
  element.addEventListener("click", (e) => {
    e.preventDefault();
    const formId = element.id.replace("-btn", "-contact-form");
    const closeBtnId = element.id.replace("-btn", "-close");
    console.log(formId);
